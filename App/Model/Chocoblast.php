...
class Chocoblast extends BddConnect{
    ...
    public function findAll(){
        try{
            $req= $this->connexion()->prepare('SELECT id_chocoblast, slogan_chocoblast, date_chocoblast, cible.nom_utilisateur AS cible_nom , cible.prenom_utilisateur AS cible_prenom, cible.image_utilisateur AS cible_image, auteur.nom_utilisateur AS auteur_nom, auteur.prenom_utilisateur AS auteur_prenom, auteur.image_utilisateur AS auteur_image FROM chocoblast INNER JOIN utilisateur AS cible ON chocoblast.cible_chocoblast = cible.id_utilisateur INNER JOIN utilisateur AS auteur on chocoblast.auteur_chocoblast = auteur.id_utilisateur');
            $req->execute();
